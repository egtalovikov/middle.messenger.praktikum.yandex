...
const inputs = [
  ...
  },
  {
    ...
    type: "text",
    name: "login",
    errorText: "Логин должен содержать только латинские буквы, цифры, дефис и нижнее подчёркивание. Первый символ - буква"
  },
  {
    text: "Имя",
    type: "text",
...
const form = new Form({ formClassName: styles.form, inputs, submitButton, convertInputs: true });
...
export default class EditProfile extends Block {
  ...
  render() {
    return this.compile(tpl, { ...this._props, form: this._children.form, popup: this._children.popup });
  }
}
